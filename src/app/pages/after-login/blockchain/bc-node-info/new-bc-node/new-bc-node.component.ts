...
export class NewBcNodeComponent implements OnInit {
    ...
    constructor(private ref: NbDialogRef<NewBcNodeComponent>, private fb: FormBuilder, private readonly authService: AuthService, private blockchainService: BlockChainService, private readonly utilsService: UtilsService) {}
